...
class UpdatePersonaRequest extends FormRequest
{
    ...
    {
        $personaId = $this->route('persona') ?? $this->input('idPersona');
        ...
        return [
            ...
            */
            ...
            'ci' => [
                ...
                'max:20',
                'regex:/^[0-9A-Za-z\-]+$/',
                Rule::unique('PERSONA', 'ci')->ignore($personaId, 'idPersona')
            ],
    ...
    public function messages(): array
    {
        return [
            ...
            'fecha_deshabilitacion.date' => 'La fecha debe ser válida.',
            'fecha_deshabilitacion.after_or_equal' => 'No se puede usar una fecha pasada.',
        ];
    }
