...
/**
 * Form Request para actualizar un Departamento
 * 
 * Validaciones:
 * - nombre: Obligatorio, string, máx 200 caracteres, único (ignorando actual)
...
class UpdateDepartamentoRequest extends FormRequest
{
    ...
    {
        $idDepartamento = $this->route('departamento') ?? $this->route('id');
        ...
        return [
            'nombre' => [
                ...
                Rule::unique('DEPARTAMENTO', 'nombre')
                    ->ignore($idDepartamento, 'idDepartamento'),
            ],
    ...
    public function messages(): array
    {
        return [
            ...
            'nombre.unique' => 'Ya existe otro departamento con este nombre.',
            
            'idPersonaEncargada.integer' => 'La persona encargada debe ser válida.',
            'idPersonaEncargada.exists' => 'La persona encargada no existe en el sistema o está inactiva.',
        ];
    }
