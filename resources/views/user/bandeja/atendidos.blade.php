                        ...
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                @forelse($documentos ?? [] as $doc)
                                        ...
                                        <td>
                                            <div class="btn-group btn-group-sm" role="group">
                                                ...
                                                <button class="btn btn-outline-danger" data-bs-toggle="modal" 
                                                        data-bs-target="#modalArchivar{{ $doc->idCorrespondencia }}" 
                                    ...
                                    {{-- MODAL ARCHIVAR --}}
                                    <div class="modal fade" id="modalArchivar{{ $doc->idCorrespondencia }}" tabindex="-1">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <form method="POST" action="{{ route('recibidas.archivar', $doc->idCorrespondencia) }}">
                                                    @csrf
