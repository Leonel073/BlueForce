                        ...
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                @forelse($documentos ?? [] as $doc)
                                        ...
                                        <td>
                                            <div class="btn-group btn-group-sm" role="group">
                                                ...
                                                <button class="btn btn-outline-warning" data-bs-toggle="modal" 
                                                        data-bs-target="#modalAtender{{ $doc->idCorrespondencia ?? 0 }}" 
                                    ...
                                    {{-- MODAL ATENDER --}}
                                    <div class="modal fade" id="modalAtender{{ $doc->idCorrespondencia ?? 0 }}" tabindex="-1">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <form method="POST" action="{{ route('admin.recibidas.atender', $doc->idCorrespondencia ?? 0) }}">
                                                    @csrf
