                        ...
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                @forelse($documentos ?? [] as $doc)
                                        ...
                                        <td>
                                            <div class="btn-group btn-group-sm" role="group">
                                                ...
                                                <button class="btn btn-outline-success" data-bs-toggle="modal" 
                                                        data-bs-target="#modalRecibir{{ $doc->idCorrespondencia ?? 0 }}" 
                                    ...
                                    {{-- MODAL RECIBIR --}}
                                    <div class="modal fade" id="modalRecibir{{ $doc->idCorrespondencia ?? 0 }}" tabindex="-1">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <form method="POST" action="{{ route('admin.recibidas.recibir', $doc->idCorrespondencia ?? 0) }}">
                                                    @csrf
