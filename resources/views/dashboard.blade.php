                ...
                <div class="bg-white rounded-lg shadow-sm p-6 border-l-4 border-warning">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <h3 class="text-3xl font-bold text-warning">{{ collect($estadosPorTipo)->where('nombre', '!=', 'Finalizado')->sum('cantidad') ?? 0 }}</h3>
                        </div>
                        <div class="text-4xl text-warning"><i class="bi bi-hourglass-split"></i></div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-sm p-6 border-l-4 border-danger">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <h3 class="text-3xl font-bold text-danger">{{ $urgentes ?? 0 }}</h3>
                        </div>
                        <div class="text-4xl text-danger"><i class="bi bi-exclamation-circle"></i></div>
                    </div>
                </div>
            </div>
