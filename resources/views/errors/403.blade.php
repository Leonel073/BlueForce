...
<body>
    <div class="error-container">
        ...
        <p class="error-message">
            No posees los permisos suficientes para acceder a este recurso.
        </p>

        @if(Auth::check())
            <div class="user-info">
                <strong><i class="bi bi-person-fill"></i> Sesión activa:</strong><br>
                {{ Auth::user()->name }}
                @if(Auth::user()->idRol)
                    <br><small>Rol: #{{ Auth::user()->idRol }}</small>
                @endif
            </div>

            <p class="error-message" style="color: #ff6b6b; font-weight: 600;">
        ...
        @else
            <p class="error-message">
                Inicia sesión para verificar si tienes acceso a este recurso.
            </p>
